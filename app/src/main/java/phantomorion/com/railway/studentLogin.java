...
public class studentLogin extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                ...
                .requestEmail()
                .build();
        mGoogleSignInClient = GoogleSignIn.getClient(studentLogin.this, gso);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(studentLogin.this, "SignIn Failed", Toast.LENGTH_LONG).show();
                            updateUI(null);
                        }
...
//change mainactivity to student
        ed.putString("userName",user.getDisplayName());
        ed.commit();
        Toast.makeText(studentLogin.this,"Welcome",Toast.LENGTH_LONG).show();
